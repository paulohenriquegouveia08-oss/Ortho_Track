  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`mx-auto flex h-full items-center transition-all duration-500 ${
            scrolled
        ...
        >
          ...
          <motion.div
            ...
            className={`flex items-center gap-2.5 origin-left transition-all duration-500 ${scrolled ? "gap-2" : "gap-2.5"}`}
          >
          ...
          {/* Nav links */}
          <nav
            className={`hidden md:flex items-center transition-all duration-500 ${scrolled ? "gap-4" : "gap-6"}`}
          >
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className={`text-muted hover:text-primary transition-colors whitespace-nowrap ${
          ...
          <a
            href="#piloto"
            className={`hidden md:inline-flex items-center bg-primary text-white font-semibold transition-all shadow-md shadow-primary/20 whitespace-nowrap ${
              scrolled
